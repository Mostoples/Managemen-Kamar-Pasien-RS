...
class Rs extends CI_Controller {
	...
	public function editor()
	{
		...
		if(isset($_SESSION['nama'])){
			...
			'alert("Peringatan! Anda belum login, silakan login terlebih dahulu di laman login, tunggu 3 detik, maka anda akan diarahkan secara otomatis");' .
			'setTimeout(function(){ window.location.href = "'.site_url('login').'"; }, 3000);' .
			'</script>';
