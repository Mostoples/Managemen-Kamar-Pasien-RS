<?php  
	...
	function insertLogAct1(){
		$bef=$this->input->post('bef_data');
    	$aft=$this->input->post('aft_data');
    	$data = array(
        	'origin_data'=>$bef,
			'changed_data'=>$aft,
